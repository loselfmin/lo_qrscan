...
public class SwiftLoQrscanPlugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "lo_qrscan", binaryMessenger: registrar.messenger())
    let instance = SwiftLoQrscanPlugin()
    registrar.addMethodCallDelegate(instance, channel: channel)
  }

  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    self.result = result
    if (call.method == "scan_qr") {
        print("scan_qr")
...
extension SwiftLoQrscanPlugin: AVCaptureMetadataOutputObjectsDelegate {
